...
import com.idsia.ai.agents.human.CheaterKeyboardAgent;
import com.idsia.mario.engine.level.LevelParser;
import com.idsia.mario.engine.sprites.Mario;
import com.idsia.mario.environments.Environment;
import com.idsia.tools.EvaluationInfo;
import com.idsia.tools.GameViewer;
import com.idsia.tools.tcp.ServerAgent;
...
//        evaluationInfo.Memo = "Number of attempt: " + Mario.numberOfAttempts;
     ...
     * @param level
     */
    public void startLevel(long seed, int difficulty, int type, int levelLength, int timeLimit, com.idsia.mario.engine.level.Level level) {
    ...
    public void startLevel(long seed, int difficulty, int type, int levelLength, int timeLimit, String filename, int index) {
        ...
        com.idsia.mario.engine.level.Level level = parser.createLevelJson(input);
