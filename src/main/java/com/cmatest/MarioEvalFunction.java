...
import com.communication.GANProcess;
...
public class MarioEvalFunction implements IObjectiveFunction {
	...
	public MarioEvalFunction() throws IOException {
        ...
        public MarioEvalFunction(String GANPath, String GANDim, String WsPath) throws IOException {
    		// set up process for GAN
    		ganProcess = new GANProcess(GANPath, GANDim, WsPath);
    		ganProcess.start();
    		// set up mario game
    		marioProcess = new MarioProcess();
    		marioProcess.start();        
