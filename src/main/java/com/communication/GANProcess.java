...
import static com.basic.map.Settings.*;
...
public class GANProcess extends Comm {
    ...
    public GANProcess(String GANPath, String GANDim, String WsPath) {
        super();
        this.threadName = "GANThread";
        this.GANPath = GANPath;
        this.GANDim = GANDim;
    ...
    public void launchGAN() {
        ...
        }else if(this.GANPath == null && this.WsPath == null){
            builder = new ProcessBuilder(PYTHON_PROGRAM, WASSERSTEIN_PATH, this.GANPath, this.GANDim);
        }else {
        	builder = new ProcessBuilder(PYTHON_PROGRAM, this.WsPath, this.GANPath, this.GANDim);
        }
