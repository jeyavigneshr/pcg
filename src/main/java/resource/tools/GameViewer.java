...
public class GameViewer extends JFrame {
	...
	private class GameViewerView extends JPanel implements Runnable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 9161940804446360105L;
		Thread animator;
		...
		public void paint(Graphics g) {
			...
			if (toolsConfigurator.getMarioComponent() != null) {
				for (String s : toolsConfigurator.getMarioComponent().getTextObservation(
						ShowEnemiesObservation.getState(), ShowLevelMapObservation.getState(),
						ShowMergedObservation.getState(), ZLevelMapValue, ZLevelEnemiesValue)) {
