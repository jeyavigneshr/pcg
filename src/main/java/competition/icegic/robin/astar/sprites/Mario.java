...
public class Mario extends Sprite implements Cloneable {
	...
	public void stomp(Enemy enemy) {
		...
		if (world.verbose > 0)
			System.out.println("STOMP! targetY: " + targetY + " enemyy: " + enemy.y + " height: " + enemy.height);
		move(0, targetY - y);
		...
		ya = jumpTime * yJumpSpeed;
		if (world.verbose > 0)
			System.out.println("Stomp ya: " + ya + " marioY: " + this.y);
		onGround = false;
		sliding = false;
		invulnerableTime = 1;
	...
	public void stomp(BulletBill bill) {
		...
		move(0, targetY - y);
		if (world.verbose > 0)
			System.out.println("STOMP! targetY: " + targetY + " enemyy: " + bill.y + " height: " + bill.height);
