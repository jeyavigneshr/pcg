...
public class Stats {
	...
	/**
	 * Returns the standard error of an array of double, where this is defined as
	 * the standard deviation of the sample divided by the square root of the sample
	 * size.
	 */
	...
	/**
	 * @return A String summary of the with the mean and standard deviation of the
	 *         data.
	 */
